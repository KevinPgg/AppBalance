...
const cafeLight: RawTokens = {
  desk: '#DBCFBB', bg: '#EFE7DA', surface: '#FBF7F0', foam: '#F5ECDD', iconBg: '#F5ECDD',
  ...
  heroFrom: '#5A4535', heroTo: '#33261E', heroPanel: '#4A3A2D', heroPanelBorder: '#5E4C3C',
...
const cafeDark: RawTokens = {
  desk: '#140E09', bg: '#1D1611', surface: '#28201A', foam: '#322820', iconBg: '#F5ECDD',
  ...
  heroFrom: '#3A2A20', heroTo: '#150E09', heroPanel: '#2C221A', heroPanelBorder: '#3C2E24',
...
const cherryLight: RawTokens = {
  desk: '#F0CDD6', bg: '#FDEDF1', surface: '#FFF7F9', foam: '#FBDEE6', iconBg: '#FBDEE6',
  ...
  heroFrom: '#C23256', heroTo: '#7C1734', heroPanel: '#9E2A49', heroPanelBorder: '#B8395C',
...
const cherryDark: RawTokens = {
  desk: '#17080D', bg: '#240B13', surface: '#33121C', foam: '#3F1826', iconBg: '#FBDEE6',
  ...
  heroFrom: '#6E1730', heroTo: '#2A0A14', heroPanel: '#4C1626', heroPanelBorder: '#642036',
...
function buildTheme(t: RawTokens) {
  return {
    ...
    onAccent: t.onAccent,
    iconBg: t.iconBg, // chip claro detrás de iconos de categoría (legibles en oscuro y sobre tiles activos)
    heroPanel: t.heroPanel,             // fondo OPACO de los pills del hero (para que las burbujas no se transparenten)
    heroPanelBorder: t.heroPanelBorder,
